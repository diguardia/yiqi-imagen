...
(function(){
  ...
  const APPS = {
    ...
    pos:{accent:'amber', icon:'pos', state:'live', id:'yiqi-pos', img:'img/apps/yiqi-pos-horiz.webp', title:'YiQi <em>POS</em>',
      ...
      b:[['Funciona offline','vendés sin internet'],['Multi-caja y turnos','cierres y arqueos'],['Impresión fiscal','Epson y Hasar']], cta:'Conocer la app'},
    pick:{accent:'green', icon:'pick', state:'dev', id:'picking-list', img:'img/apps/picking-list-horiz.webp', title:'Picking <em>List</em>',
      ...
      b:[['Picking multi-pedido','preparás varios a la vez'],['Por ubicación','recorrido optimizado'],['Control de salida','remitos y etiquetas']], cta:'Conocer la app'},
